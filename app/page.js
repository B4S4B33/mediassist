...
export default function LandingPage() {
  ...
  if (!isLoaded || !mounted) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-600 via-primary-700 to-blue-800">
              ...
              {mounted && (
                <>
                  <SignInButton mode="modal">
                    <button className="text-white hover:text-gray-200 font-medium transition-colors cursor-pointer">
                      Sign In
                    </button>
                  </SignInButton>
                  <SignUpButton mode="modal">
                    <button className="bg-white text-primary-600 hover:bg-gray-100 font-bold py-2 px-6 rounded-lg transition-all duration-200 cursor-pointer">
                      Get Started
                    </button>
                  </SignUpButton>
                </>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {mounted && (
              <>
                <SignUpButton mode="modal">
                  <button className="bg-white text-primary-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-lg text-lg transition-all duration-200 flex items-center justify-center space-x-2 cursor-pointer">
                    <span>Start Your Health Journey</span>
                    <ArrowRight className="h-5 w-5" />
                  </button>
                </SignUpButton>
                <SignInButton mode="modal">
                  <button className="border-2 border-white text-white hover:bg-white hover:text-primary-600 font-bold py-4 px-8 rounded-lg text-lg transition-all duration-200 cursor-pointer">
                    Try AI Chat
                  </button>
                </SignInButton>
              </>
