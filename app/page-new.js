...
// Temporary: Clerk authentication disabled
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button 
                ...
                className="bg-white text-primary-600 hover:bg-gray-100 font-bold py-2 px-6 rounded-lg transition-all duration-200"
              >
                Get Started
              </button>
            </div>
      ...
      <div className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              onClick={() => router.push('/form')}
              className="bg-white text-primary-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-lg text-lg transition-all duration-200 flex items-center justify-center space-x-2"
            >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="mt-8">
                  <button 
                    onClick={() => router.push('/form')}
                    className="bg-primary-600 text-white hover:bg-primary-700 font-bold py-3 px-8 rounded-lg text-lg transition-all duration-200 inline-flex items-center space-x-2"
                  >
      ...
      <div className="bg-gradient-to-r from-primary-600 to-blue-700 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              onClick={() => router.push('/form')}
              className="bg-white text-primary-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-lg text-lg transition-all duration-200 inline-flex items-center justify-center space-x-2"
            >
